...
// Export VSCode-style terminal component
export { VSCodeTerminal } from './components/VSCodeTerminal';
export type { VSCodeTerminalProps } from './components/VSCodeTerminal';
